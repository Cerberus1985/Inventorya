...
if ((isset($_POST['operacion']) && isset($_POST['tabla'])) || (isset($_GET['operacion']) && isset($_GET['tabla']))) {
    ...
    switch ($operacion) {
        ...
        case 'insertar':
            ...
            break;
        default:
            $temporal = ['Estatus' => 'ERROR', 'TYPE' => 'Operacion no encontrada||inicializada', 'tabla' => $tableName, 'cabezeras' => ['Estatus', 'Descripcion'], 'cantidadDatos' => 0, 'datos' => null, 'index' => $offset = null, 'limit' => $limit = null];
